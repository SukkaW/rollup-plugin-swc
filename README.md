...
| ---------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| `minify` your bundle in one pass[^1]           | Yes                                                                     | No                                                                            | No                                                                                  | No                                                                               |
| Standalone `swcMinify` plugin                  | Yes                                                                     | No                                                                            | No                                                                                  | No                                                                               |
| Config Intellisense[^2]                        | Yes                                                                     | No                                                                            | No                                                                                  | No                                                                               |
| Reads your `tsconfig.json` and `jsconfig.json` | Yes                                                                     | No                                                                            | No                                                                                  | Yes                                                                              |
| ESM export                                     | Full                                                                    | Partial[^3]                                                                   | No                                                                                  | Full                                                                             |
| TypeScrit declarations                         | Yes                                                                     | Yes                                                                           | Yes                                                                                 | Yes                                                                              |
| Has testing                                    | Yes                                                                     | No                                                                            | No                                                                                  | Yes                                                                              |
